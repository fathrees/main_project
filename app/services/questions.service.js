(function() {
    ...
    questionsService.$inject = ["$http", "$q", "BASE_URL", "URL", "ENTITIES", "ACTIONS", "ENTITY_RANGE_ON_PAGE", "MESSAGE"];

    function questionsService($http, $q, BASE_URL, URL, ENTITIES, ACTIONS, ENTITY_RANGE_ON_PAGE, MESSAGE) {
        var service = {
